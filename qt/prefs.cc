...
Prefs::PrefItem Prefs::myItems[] =
{
    ...
    { BACKUP_TRACKERS, "show-backup-trackers", QVariant::Bool },
    ...
    { TRACKER_SCRAPES, "show-tracker-scrapes", QVariant::Bool },
...
Prefs :: initDefaults( tr_benc * d )
{
    ...
    tr_bencDictAddInt( d, keyStr(BACKUP_TRACKERS), false );
    tr_bencDictAddInt( d, keyStr(TRACKER_SCRAPES), false );
